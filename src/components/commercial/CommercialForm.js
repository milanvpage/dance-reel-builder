...
class CommercialForm extends Component {
    ...
    handleSubmit = (e) => {
        ...
        this.setState({
            name: "", 
            url: ""
    }) // this will clear our name in the inout field so when I hit submit the input clears
    }
    ...
    render() {
        return (
            <form  className= "form" onSubmit={this.handleSubmit}>
                ...
                <input className="name" name="name" id="commercial-name-input" onChange={this.handleChange} value={this.state.name} type="text" /> 
                ...
                <br/>
                <br/>
                <label htmlFor="commercial-url-input">URL:</label>
                <input name="url" id="commercial-url-input" onChange={this.handleChange} value={this.state.url} type="text" /> 
                <br/>
                <br/>
                <input type="submit" />
            </form>
