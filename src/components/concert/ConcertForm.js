...
export default class ConcertForm extends Component {
    ...
    handleSubmit = (e) => {
        ...
        this.props.dispatchAddConcert(this.state) // calling the function I'm passing through as a prop in my mapDispatchToProps function - so my handleSUbmit can call that function everytime you hit sumbit button
